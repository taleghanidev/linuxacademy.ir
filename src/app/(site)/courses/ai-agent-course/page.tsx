...
const DESCRIPTION =
  "کارگاه آنلاین زنده ساخت ایجنت هوش مصنوعی؛ شروع جمعه ۱ آبان ۱۴۰۵، جمعه‌ها ۱۲:۰۰ تا ۱۴:۰۰ به وقت تهران، ۸ جلسه و ۱۶ ساعت آموزش، ۱۲ فصل و ۹۳ درس، ظرفیت ۱۲ نفر، همراه با پروژه پایانی.";
