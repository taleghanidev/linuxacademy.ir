...
const DESCRIPTION =
  "کارگاه آنلاین زنده ساخت ایجنت هوش مصنوعی؛ جمعه‌ها ۱۲:۰۰ تا ۱۴:۰۰ به وقت تهران، ۸ جلسه و ۱۶ ساعت آموزش، ۱۲ فصل و ۱۰۴ درس، ظرفیت ۱۲ نفر، همراه با پروژه پایانی و گواهی پایان دوره.";
