...
import termsOfServiceEn from "@/language/en/pages/termsOfService";
import navBarFa from "@/language/fa/components/navBar";
import termsOfServiceFa from "@/language/fa/pages/termsOfService";
...
const TermsOfService = () => {
  ...
  const lang = document.documentElement.dir === "rtl" ? termsOfServiceFa : termsOfServiceEn;
